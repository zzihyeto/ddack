...
<html lang="en">
    <head>
        ...
        <title>All about DDackRigo</title>
        <!-- Favicon-->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                <h1 class="fw-bolder mb-3">Introduce Our Team "DDackRigo"</h1>
                ...
                <div class="container px-5 my-5">
                    <div class="row gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="lead fw-normal text-muted mb-0">회원가입 기능 구현, 로그인할 때 일반 회원과 관리자를 나눠서 진행하였고. 상품들이 나열되고 리뷰도 볼수 있고 회원이 주문한 상품을 조회가능 하게 하였습니다.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="py-5 bg-light">
                <div class="container px-5 my-5">
                    <div class="text-center">
                        <h2 class="fw-bolder">Team DDackRigo</h2>
