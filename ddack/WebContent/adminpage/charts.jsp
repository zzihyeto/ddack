			...
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-body">
							수요과 공급예측을 해봅시다. 
							<br>시기별 검색량에 따른 닭가슴살 판매량 예측을 통해 생산하고 판매해봅시다.
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="card mb-4">
								...
								<div class="card-body">
									<canvas id="ddack3" width="100%" height="50"></canvas>
								</div>
						...
						<div class="col-lg-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-bar me-1"></i> 닭가슴살검색량에 따른 매출량 수요예측
								</div>
								<div class="card-body">
									<canvas id="ddack1" width="100%" height="50"></canvas>
								</div>
								<div class="card-footer small text-muted">Updated
									yesterday at 11:59 PM</div>
							</div>
