			...
			<div class="container">
				<ul class="pagination justify-content-center">
					...
					<c:if test="${startPage!=1}">
						<li class="page-item"><a href="list.re?page=1"
							class="page-link"><i class="fas fa-fast-backward"></i></a></li>
						<li class="page-item"><a href="list.re?page=${startPage-10}"
							class="page-link"><i class="fas fa-backward"></i></a></li>
					</c:if>

					<c:forEach var="page_num" begin="${startPage}" end="${endPage}">
						<li class="page-item"><a href="list.re?page=${page_num}"
							class="page-link">${page_num}</a></li>
					</c:forEach>

					<c:if test="${endPage < totalPage}">
						<li class="page-item"><a href="list.re?page=${endPage+1}"
							class="page-link"><i class="fas fa-forward"></i></a></li>
						<li class="page-item"><a href="list.re?page=${totalPage}"
							class="page-link"><i class="fas   "></i></a></li>
					</c:if>
				</ul>
			</div>
